...
class MapboxNavigation(
     ...
     */
    private val navigationVersionSwitchObservers = mutableListOf<NavigationVersionSwitchObserver>()
    ...
    /**
     * Stop observing tiles version switch.
     */
    ...
    private fun recreateNavigatorInstance(isFallback: Boolean, tilesVersion: String) {
        ...
        route?.let {
            mainJobController.scope.launch {
                navigator.setRoute(it, routeProgress?.currentLegProgress?.legIndex ?: 0)
            }
        }
    }
